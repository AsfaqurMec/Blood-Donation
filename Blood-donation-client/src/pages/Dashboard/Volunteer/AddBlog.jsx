...
// console.log(remain);
    const handleSubmit = async e => {
        ...
        const handleChange = e => {
            ...
            const handleDraft = (id) => {
                ...
                fetch(`https://blood-donation-green.vercel.app/blogs/${id}`, {
                    method: 'PUT',
                    headers: {
    ...
    return (
      ...
      <h1 className="text-center text-green-700 text-3xl font-semibold mb-6">All Blogs</h1>
...
<tbody>
                    { 
                     remain.map(donate => 
                        ...
                        <td className="px-[5px] md:px-3 font-bold text-lg">{donate.title}</td>
                        <td className="px-[5px] md:px-3 font-bold text-lg"><img className='w-10 h-10' src={donate.image} alt="" /></td>
                        ...
                        <button onClick={()=>handleDraft(donate?._id)}
                             className="btn md:mr-2 btn-primary">Publish</button>
                     
                       : '' }

                       { donate.status == 'published'?
                        
                        <button onClick={()=>handlePublish(donate?._id)}
                             className="btn md:mr-2 btn-primary">Unpublish</button>
